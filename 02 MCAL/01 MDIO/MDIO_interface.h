...
#ifndef MDIO_INTERFACE
#define	MDIO_INTERFACE
...
* Parameters 	: PORT number(PORTA -> PORTD),Mode(OUTPUT, INPUT) 	  *			                      *
* Return type 	: void                                      	     	  *
...
* Parameters 	: PORT number(PORTA -> PORTD),Value 		  *			                      *
* Return type 	: void                                      	      *
* Descriptio 	: Function to set port value  					  *
***********************************************************************/
...
* Parameters 	: PORT number(PORTA -> PORTD),Value 		 	      *			                      *
* Return type 	: void                                      	      *
* Descriptio 	: Function to set high nibble value  				  *
***********************************************************************/
...
* Parameters 	: PORT number(PORTA -> PORTD),Value 		 	      *			                      *
* Return type 	: void                                      	      *
* Descriptio 	: Function to set low nibble value  				  *
***********************************************************************/
